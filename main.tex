...
\begin{frame}[plain]
	...
	\begin{figure}
	  \animategraphics[loop,controls=play,width=0.8\linewidth]{8}{gammaI/gamma_rot}{0}{26} %26
...
\centering
 	  \animategraphics[controls=play,width=\linewidth]{2}{map/maps}{1}{23} %26
 		% remove the 'draft' keyword, when replacing with final figure!
 		\vskip 0.2 cm
 		\footnotesize
...
\end{figure}
 ...
 %\frametitle{Testing the mapper}
 	\begin{figure}
 	   \animategraphics[controls=play,width=0.9\linewidth]{2}{LIGO/LIGOmap}{0}{29} %26
 		% remove the 'draft' keyword, when replacing with final figure!
 		\medskip\\
